...
select cinsiyet, round(avg(maas),2) as maas_ortalamasi from insan group by cinsiyet;
...
group by ulke having sum(maas)>30000;
...
union
select maas, isim,sirket from personel where sirket!='Honda';
