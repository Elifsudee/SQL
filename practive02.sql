...
update student_info set student_dob='11-Dec-1997' where student_name='JOHN DOE';

--105 id'li dob hücresini 11-Apr-1997 değerine ve name hücresini MARK TWAIN değerine güncelle.
update student_info
set student_dob='11-Apr-1997', student_name='MARK TWAIN'
where student_id=105;

--id'si 106'dan küçük tüm student_dob değerlerini 01-Aug-2021'e güncelle.
update student_info
set student_dob='01-Aug-2021' where student_id<106; 
...
select max(worker_salary)*0.8 from workers
...
where name is null;-- =null kullanmayiniz
...
--address değeri Michigan olmayan recordları siliniz. --(JAVA) !=   ==>    (SQL) <>==>esit degildir
 delete from people
...
select * from workers 
where salary=2000 or salary=12000;--salary in(2000,12000) de olur
...
select max(salary) as ikinci_en_yuksek_salary from workers
