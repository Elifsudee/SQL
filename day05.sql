...
select * from child;-- child tablosundaki verileri de sildi.
...
select round(avg(fiyat),2) as ortlama_fiyat from arac;

--round onadlikli kismdan kurtulmak icin kullanilan bir komuttur
...
--ceabi daha dinamik hale getirelim
...
select * from meslekler order by isim;--default olarak kucukten buyuge siralar
